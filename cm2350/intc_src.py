...
class INTC_EVENT(enum.Enum):
    ...
    EDMA_A_IRQ0             = enum.auto()  # EDMA_A_IRQRL[0]
    EDMA_A_IRQ1             = enum.auto()  # EDMA_A_IRQRL[1]
    EDMA_A_IRQ2             = enum.auto()  # EDMA_A_IRQRL[2]
    EDMA_A_IRQ3             = enum.auto()  # EDMA_A_IRQRL[3]
    EDMA_A_IRQ4             = enum.auto()  # EDMA_A_IRQRL[4]
    EDMA_A_IRQ5             = enum.auto()  # EDMA_A_IRQRL[5]
    EDMA_A_IRQ6             = enum.auto()  # EDMA_A_IRQRL[6]
    EDMA_A_IRQ7             = enum.auto()  # EDMA_A_IRQRL[7]
    EDMA_A_IRQ8             = enum.auto()  # EDMA_A_IRQRL[8]
    EDMA_A_IRQ9             = enum.auto()  # EDMA_A_IRQRL[9]
    EDMA_A_IRQ10            = enum.auto()  # EDMA_A_IRQRL[10]
    EDMA_A_IRQ11            = enum.auto()  # EDMA_A_IRQRL[11]
    EDMA_A_IRQ12            = enum.auto()  # EDMA_A_IRQRL[12]
    EDMA_A_IRQ13            = enum.auto()  # EDMA_A_IRQRL[13]
    EDMA_A_IRQ14            = enum.auto()  # EDMA_A_IRQRL[14]
    EDMA_A_IRQ15            = enum.auto()  # EDMA_A_IRQRL[15]
    EDMA_A_IRQ16            = enum.auto()  # EDMA_A_IRQRL[16]
    EDMA_A_IRQ17            = enum.auto()  # EDMA_A_IRQRL[17]
    EDMA_A_IRQ18            = enum.auto()  # EDMA_A_IRQRL[18]
    EDMA_A_IRQ19            = enum.auto()  # EDMA_A_IRQRL[19]
    EDMA_A_IRQ20            = enum.auto()  # EDMA_A_IRQRL[20]
    EDMA_A_IRQ21            = enum.auto()  # EDMA_A_IRQRL[21]
    EDMA_A_IRQ22            = enum.auto()  # EDMA_A_IRQRL[22]
    EDMA_A_IRQ23            = enum.auto()  # EDMA_A_IRQRL[23]
    EDMA_A_IRQ24            = enum.auto()  # EDMA_A_IRQRL[24]
    EDMA_A_IRQ25            = enum.auto()  # EDMA_A_IRQRL[25]
    EDMA_A_IRQ26            = enum.auto()  # EDMA_A_IRQRL[26]
    EDMA_A_IRQ27            = enum.auto()  # EDMA_A_IRQRL[27]
    EDMA_A_IRQ28            = enum.auto()  # EDMA_A_IRQRL[28]
    EDMA_A_IRQ29            = enum.auto()  # EDMA_A_IRQRL[29]
    EDMA_A_IRQ30            = enum.auto()  # EDMA_A_IRQRL[30]
    EDMA_A_IRQ31            = enum.auto()  # EDMA_A_IRQRL[31]
    EDMA_A_IRQ32            = enum.auto()  # EDMA_A_IRQRL[32]
    EDMA_A_IRQ33            = enum.auto()  # EDMA_A_IRQRL[33]
    EDMA_A_IRQ34            = enum.auto()  # EDMA_A_IRQRL[34]
    EDMA_A_IRQ35            = enum.auto()  # EDMA_A_IRQRL[35]
    EDMA_A_IRQ36            = enum.auto()  # EDMA_A_IRQRL[36]
    EDMA_A_IRQ37            = enum.auto()  # EDMA_A_IRQRL[37]
    EDMA_A_IRQ38            = enum.auto()  # EDMA_A_IRQRL[38]
    EDMA_A_IRQ39            = enum.auto()  # EDMA_A_IRQRL[39]
    EDMA_A_IRQ40            = enum.auto()  # EDMA_A_IRQRL[40]
    EDMA_A_IRQ41            = enum.auto()  # EDMA_A_IRQRL[41]
    EDMA_A_IRQ42            = enum.auto()  # EDMA_A_IRQRL[42]
    EDMA_A_IRQ43            = enum.auto()  # EDMA_A_IRQRL[43]
    EDMA_A_IRQ44            = enum.auto()  # EDMA_A_IRQRL[44]
    EDMA_A_IRQ45            = enum.auto()  # EDMA_A_IRQRL[45]
    EDMA_A_IRQ46            = enum.auto()  # EDMA_A_IRQRL[46]
    EDMA_A_IRQ47            = enum.auto()  # EDMA_A_IRQRL[47]
    EDMA_A_IRQ48            = enum.auto()  # EDMA_A_IRQRL[48]
    EDMA_A_IRQ49            = enum.auto()  # EDMA_A_IRQRL[49]
    EDMA_A_IRQ50            = enum.auto()  # EDMA_A_IRQRL[50]
    EDMA_A_IRQ51            = enum.auto()  # EDMA_A_IRQRL[51]
    EDMA_A_IRQ52            = enum.auto()  # EDMA_A_IRQRL[52]
    EDMA_A_IRQ53            = enum.auto()  # EDMA_A_IRQRL[53]
    EDMA_A_IRQ54            = enum.auto()  # EDMA_A_IRQRL[54]
    EDMA_A_IRQ55            = enum.auto()  # EDMA_A_IRQRL[55]
    EDMA_A_IRQ56            = enum.auto()  # EDMA_A_IRQRL[56]
    EDMA_A_IRQ57            = enum.auto()  # EDMA_A_IRQRL[57]
    EDMA_A_IRQ58            = enum.auto()  # EDMA_A_IRQRL[58]
    EDMA_A_IRQ59            = enum.auto()  # EDMA_A_IRQRL[59]
    EDMA_A_IRQ60            = enum.auto()  # EDMA_A_IRQRL[60]
    EDMA_A_IRQ61            = enum.auto()  # EDMA_A_IRQRL[61]
    EDMA_A_IRQ62            = enum.auto()  # EDMA_A_IRQRL[62]
    EDMA_A_IRQ63            = enum.auto()  # EDMA_A_IRQRL[63]
    ...
    EDMA_B_IRQ0             = enum.auto()  # EDMA_B_IRQRL[0]
    EDMA_B_IRQ1             = enum.auto()  # EDMA_B_IRQRL[1]
    EDMA_B_IRQ2             = enum.auto()  # EDMA_B_IRQRL[2]
    EDMA_B_IRQ3             = enum.auto()  # EDMA_B_IRQRL[3]
    EDMA_B_IRQ4             = enum.auto()  # EDMA_B_IRQRL[4]
    EDMA_B_IRQ5             = enum.auto()  # EDMA_B_IRQRL[5]
    EDMA_B_IRQ6             = enum.auto()  # EDMA_B_IRQRL[6]
    EDMA_B_IRQ7             = enum.auto()  # EDMA_B_IRQRL[7]
    EDMA_B_IRQ8             = enum.auto()  # EDMA_B_IRQRL[8]
    EDMA_B_IRQ9             = enum.auto()  # EDMA_B_IRQRL[9]
    EDMA_B_IRQ10            = enum.auto()  # EDMA_B_IRQRL[10]
    EDMA_B_IRQ11            = enum.auto()  # EDMA_B_IRQRL[11]
    EDMA_B_IRQ12            = enum.auto()  # EDMA_B_IRQRL[12]
    EDMA_B_IRQ13            = enum.auto()  # EDMA_B_IRQRL[13]
    EDMA_B_IRQ14            = enum.auto()  # EDMA_B_IRQRL[14]
    EDMA_B_IRQ15            = enum.auto()  # EDMA_B_IRQRL[15]
    EDMA_B_IRQ16            = enum.auto()  # EDMA_B_IRQRL[16]
    EDMA_B_IRQ17            = enum.auto()  # EDMA_B_IRQRL[17]
    EDMA_B_IRQ18            = enum.auto()  # EDMA_B_IRQRL[18]
    EDMA_B_IRQ19            = enum.auto()  # EDMA_B_IRQRL[19]
    EDMA_B_IRQ20            = enum.auto()  # EDMA_B_IRQRL[20]
    EDMA_B_IRQ21            = enum.auto()  # EDMA_B_IRQRL[21]
    EDMA_B_IRQ22            = enum.auto()  # EDMA_B_IRQRL[22]
    EDMA_B_IRQ23            = enum.auto()  # EDMA_B_IRQRL[23]
    EDMA_B_IRQ24            = enum.auto()  # EDMA_B_IRQRL[24]
    EDMA_B_IRQ25            = enum.auto()  # EDMA_B_IRQRL[25]
    EDMA_B_IRQ26            = enum.auto()  # EDMA_B_IRQRL[26]
    EDMA_B_IRQ27            = enum.auto()  # EDMA_B_IRQRL[27]
    EDMA_B_IRQ28            = enum.auto()  # EDMA_B_IRQRL[28]
    EDMA_B_IRQ29            = enum.auto()  # EDMA_B_IRQRL[29]
    EDMA_B_IRQ30            = enum.auto()  # EDMA_B_IRQRL[30]
    EDMA_B_IRQ31            = enum.auto()  # EDMA_B_IRQRL[31]
...
INTC_EVENT_MAP = {
    ...
    INTC_EVENT.EDMA_B_IRQ0:         (INTC_SRC.EDMA_B_IRQ0,          None),
    INTC_EVENT.EDMA_B_IRQ1:         (INTC_SRC.EDMA_B_IRQ1,          None),
    INTC_EVENT.EDMA_B_IRQ2:         (INTC_SRC.EDMA_B_IRQ2,          None),
    INTC_EVENT.EDMA_B_IRQ3:         (INTC_SRC.EDMA_B_IRQ3,          None),
    INTC_EVENT.EDMA_B_IRQ4:         (INTC_SRC.EDMA_B_IRQ4,          None),
    INTC_EVENT.EDMA_B_IRQ5:         (INTC_SRC.EDMA_B_IRQ5,          None),
    INTC_EVENT.EDMA_B_IRQ6:         (INTC_SRC.EDMA_B_IRQ6,          None),
    INTC_EVENT.EDMA_B_IRQ7:         (INTC_SRC.EDMA_B_IRQ7,          None),
    INTC_EVENT.EDMA_B_IRQ8:         (INTC_SRC.EDMA_B_IRQ8,          None),
    INTC_EVENT.EDMA_B_IRQ9:         (INTC_SRC.EDMA_B_IRQ9,          None),
